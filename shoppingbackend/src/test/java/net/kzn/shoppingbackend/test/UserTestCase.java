...
*/
	...
	public void testUpdateUser() {
		...
		user.setConfirmPassword("22222");
		
		assertEquals("failed to update user",true,userDAO.update(user));
	...
	public void testGetAllUser() {
		assertEquals("failed to fetch the user details",5,userDAO.list().size());
	}*/
	
	@Test
	public void testUserAddress() {
		Address address = userDAO.getBillingAddress(33);
		assertEquals("failed to fetch the user details","Dhaka",address.getCity());
	}
