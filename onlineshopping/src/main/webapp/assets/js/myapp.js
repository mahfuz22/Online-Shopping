$(function() {
		...
		$adminForm.validate({
			...
			messages : {
				...
				password : {
					...
					minlength: 'Minimum length is 6 character'
				},
				confirmPassword : {
	...
	// execute the below code only where we have this table
	if ($userTable.length) {
		console.log('Inside the user table!');
							...
							},
							{
								...
								mRender : function(data, type, row) {
									...
									str += '<a href="'
											...
											+ '/manage/user/'
											+ data
											+ '/address" class="btn btn-danger btn-xs"><i class="fa fa-map-marker" aria-hidden="true"></i>&#160;Address</a>';
									return str;
								}
							},
							{
								...
								mRender : function(data, type, row) {
									...
									if (row.role == 'USER') {
										str += '<a href="'
												...
												+ '/manage/user/'
												+ data
												+ '/order" class="btn btn-danger btn-xs"><i class="fa fa-first-order" aria-hidden="true"></i>&#160;Order</a>';
									} else {
										str += '<h5 style="color:red">Unavailable</h5>';
									}
									return str;
								}
							} ],
