...
<!-- HTML5 Shim and Respond.js IE8 support of HTML5 lements and media queries -->
...
<body>
	...
	<div class="wrapper">
		...
		<div class="content">
			...
			<!-- Load only when user clicks manage user -->
			<c:if test="${adminClickManageUser == true}">
				<%@include file="manageUser.jsp"%>
			</c:if>
			
			<!-- Load only when user clicks manage user -->
			<c:if test="${adminClickAddress == true}">
			...
			<!-- Load only when user clicks user account -->
			<c:if test="${userClickManageAccount == true}">
				<%@include file="user-account.jsp"%>
			</c:if>
			
			<!-- Load only when user clicks user account -->
			<c:if test="${adminClickOrder == true}">
				<%@include file="user-order.jsp"%>
			</c:if>
			...
			<c:if test="${adminClickAdminInfo == true}">
